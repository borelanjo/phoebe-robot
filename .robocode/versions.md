...
[Bug-349]: https://sourceforge.net/p/robocode/bugs/349/  (Instances of RobocodeEngine don't seem to be independant - memory leak and performance decrease)
[Bug-350]: https://sourceforge.net/p/robocode/bugs/350/  (Bullet id from battle record XML file is sometimes -1 causing a NumberFormatException)
[Bug-351]: https://sourceforge.net/p/robocode/bugs/351/  (Robot.onBattleEnded(BattleEndedEvent) provides wrong scores)
[Bug-352]: https://sourceforge.net/p/robocode/bugs/352/  (Results from BattleCompletedEvent.getIndexedResults() are always sorted)
[Bug-353]: https://sourceforge.net/p/robocode/bugs/353/  (RobocodeEngine.setVisible() can cause a NullPointerException)
[Bug-354]: https://sourceforge.net/p/robocode/bugs/354/  (Replaying an XML record can cause an ArrayIndexOutOfBoundsException)
...
[Bug-357]: https://sourceforge.net/p/robocode/bugs/357/  (Tab characters are inserted in the last line of a robot source file when opening it)
[Bug-358]: https://sourceforge.net/p/robocode/bugs/358/  (Robot in default package cannot write to files. Should at least get a warning)
[Bug-361]: https://sourceforge.net/p/robocode/bugs/361/  (Problem in the text editor related with the .java file modification)
[Bug-362]: https://sourceforge.net/p/robocode/bugs/362/  (Rumble client does not remove participants in wrong codesize group)
[Bug-363]: https://sourceforge.net/p/robocode/bugs/363/  (No Last Survivor Bonus being given)
[Bug-364]: https://sourceforge.net/p/robocode/bugs/364/  (Robot Packager does not include the robot data dir in the .jar file)
...
[Bug-370]: https://sourceforge.net/p/robocode/bugs/370/  (Robot Packager cannot find robot .properties file in development path)
[Bug-371]: https://sourceforge.net/p/robocode/bugs/371/  (High cpu usage on editor)
[Bug-372]: https://sourceforge.net/p/robocode/bugs/372/  (Cannot load battle file when -DNOSECURITY=true is enabled - java.lang.IllegalAccessError)
...
[Bug-381]: https://sourceforge.net/p/robocode/bugs/381/  (Improve feedback after entering empty package name during robot creation)
...
[Bug-386]: https://sourceforge.net/p/robocode/bugs/386/  (Can't run Robocode 1.9.2.6 on Mac OS)
...
[Bug-392]: https://sourceforge.net/p/robocode/bugs/392/  (Bullets of the same bot collide at low bullet powers and high gun-cooling rate)
...
[Bug-395]: https://sourceforge.net/p/robocode/bugs/395/	 (Roborumble client duplicates battle results on network error)
...
[Bug-404]: https://sourceforge.net/p/robocode/bugs/404/  (Confusion between development/non-development versions of bots)
...
[Bug-408]: https://sourceforge.net/p/robocode/bugs/408/  (Parameter DNOSECURITY (no security manager) cause Robocode program startup access-error)
[Bug-409]: https://sourceforge.net/p/robocode/bugs/409/  (Robot repository is completely rebuilt whenever dev dir is changed via UI)
[Bug-410]: https://sourceforge.net/p/robocode/bugs/410/  (setColors methods warn that they can be called only once per battle, but it's not true)
...
[Req-1]:   https://sourceforge.net/p/robocode/feature-requests/1/    (Multiple or hyperthreading CPUs (most P4s) hangs Robocode)
[Req-2]:   https://sourceforge.net/p/robocode/feature-requests/2/    (Keep window size of "New battle" window)
[Req-3]:   https://sourceforge.net/p/robocode/feature-requests/3/    (More precise battlefieldsize configuration)
...
[Req-12]:  https://sourceforge.net/p/robocode/feature-requests/12/   (Faster framerates / Turns per second)
...
[Req-20]:  https://sourceforge.net/p/robocode/feature-requests/20/   (Robot templates must be updated regarding deprecated methods)
[Req-21]:  https://sourceforge.net/p/robocode/feature-requests/21/   (Option for accessing external .jars)
[Req-23]:  https://sourceforge.net/p/robocode/feature-requests/23/   (Preference to allow disabling of the scorecard pop-up)
...
[Req-34]:  https://sourceforge.net/p/robocode/feature-requests/34/   (Provide javadoc for robocode.util.Utils and robocode.control)
...
[Req-49]:  https://sourceforge.net/p/robocode/feature-requests/49/   (Speedup time required for rebuilding robot database)
[Req-50]:  https://sourceforge.net/p/robocode/feature-requests/50/   (Recalculate CPU Constant)
[Req-52]:  https://sourceforge.net/p/robocode/feature-requests/52/   (The 'New Battle' window sometimes is spamed with .robotcache)
...
[Req-62]:  https://sourceforge.net/p/robocode/feature-requests/62/   (Fix for massive turn skipping when cpu constant < granularity)
[Req-63]:  https://sourceforge.net/p/robocode/feature-requests/63/   (Replay should store debug graphics)
[Req-64]:  https://sourceforge.net/p/robocode/feature-requests/64/   (Change default battle settings like e.g. "Number of Rounds")
...
[Req-80]:  https://sourceforge.net/p/robocode/feature-requests/80/   (Screenshot of battleview)
[Req-82]:  https://sourceforge.net/p/robocode/feature-requests/82/   (Launch upload result in separate thread)
[Req-84]:  https://sourceforge.net/p/robocode/feature-requests/84/   (Added append option in copy method (FileTransfer class))
[Req-86]:  https://sourceforge.net/p/robocode/feature-requests/86/   (Rankings should be visible when Robocode is minimized)
[Req-88]:  https://sourceforge.net/p/robocode/feature-requests/88/   (Command Line option for saving a battle record file)
...
[Req-119]: https://sourceforge.net/p/robocode/feature-requests/119/  (Provide JuniorRobot template for inexperienced user)
[Req-121]: https://sourceforge.net/p/robocode/feature-requests/121/  (Issues with editor font)
[Req-124]: https://sourceforge.net/p/robocode/feature-requests/124/  (Ability to save the properties file for robots in dev. path)
...
[Req-147]: https://sourceforge.net/p/robocode/feature-requests/147/  (The snapshot API is ambiguous for bullets shot by teams)
[Req-156]: https://sourceforge.net/p/robocode/feature-requests/156/  (Codesize added to properties file)
[Req-159]: https://sourceforge.net/p/robocode/feature-requests/159/  (Fix overkilled garbage collection on static fields)
